...
public class SimpleCarController : MonoBehaviour
{
    ...
    public float wheelUpdateRatio = 1f;
    ...
    private void Start()
    {
        ...
        foreach (AxleInfo axleInfo in axleInfos)
        {
            ...
            axleInfo.leftWheel.ConfigureVehicleSubsteps(5, 48, 60);
            axleInfo.rightWheel.ConfigureVehicleSubsteps(5, 48, 60);
        }
    ...
    public void ApplyLocalPositionToVisuals(WheelCollider collider)
    {
        ...
        visualWheel.transform.position = Vector3.Lerp(visualWheel.transform.position, position, Time.deltaTime * wheelUpdateRatio);
