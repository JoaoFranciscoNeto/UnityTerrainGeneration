...
namespace NodeEditorFramework.Utilities 
{
	public static class RTEditorGUI 
	{
        ...
        #region Vector2
        public static Vector2 Vector2Field (Vector2 obj)
        {
            return EditorGUILayout.Vector2Field(GUIContent.none, obj);
        }

        public static Vector2 Vector2Field(string label, Vector2 obj)
        {
            return EditorGUILayout.Vector2Field(label, obj);
        }
        #endregion
